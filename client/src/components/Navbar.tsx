...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full bg-white z-10">
            ...
            <section className={`absolute w-full flex bg-white shadow-lg duration-150 h-fit pt-5 z-1 ${!featuredOpen.open && 'hidden duration-150'}`} >
                <article className="flex flex-col gap-2 p-10">
                    <span className="font-medium">Clothing</span>
                    <button className="flex hover:cursor-pointer" onClick={() => navigate(`/${featuredOpen.gender}`)}>All Items</button>
                ...
                <article className="flex flex-col gap-2 p-10">
                    ...
                    <button className="flex hover:cursor-pointer" onClick={() => navigate(`/${featuredOpen.gender}`)}>All Brands</button>
