        ...
        <main>
            ...
            <section className='flex flex-row my-4 mx-1 gap-1'>
                ...
                <article className='flex flex-col flex-1 justify-between'>
                    ...
                    <span className='mx-5 underline-offset-2 underline hover:cursor-pointer' onClick={() => { navigate('/men') }}>View more</span>
                </article>
            </section>
            <section className='flex flex-row-reverse my-4 mx-1 gap-1'>
                ...
                <article className='flex flex-col flex-1 justify-between'>
                    ...
                    <span className='mx-5 underline-offset-2 underline hover:cursor-pointer' onClick={() => { navigate('/women') }}>View more</span>
                </article>
            </section>
